...
def remove_celery_files():
    file_names = [
        ...
        os.path.join("{{ cookiecutter.python_module_name }}", "users", "tests", "test_tasks.py"),
    ]
    for file_name in file_names:
        os.remove(file_name)
...
def remove_drf_starter_files():
    ...
    os.remove(os.path.join("{{cookiecutter.python_module_name}}", "users", "tests", "test_drf_urls.py"))
    os.remove(os.path.join("{{cookiecutter.python_module_name}}", "users", "tests", "test_drf_views.py"))
    os.remove(os.path.join("{{cookiecutter.python_module_name}}", "users", "tests", "test_swagger.py"))


def remove_storages_module():
    os.remove(os.path.join("{{cookiecutter.python_module_name}}", "utils", "storages.py"))
